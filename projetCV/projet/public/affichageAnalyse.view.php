...
<body>
    ...
    <form action="affichageAnalyse.php">
    <main>
        ...
        <a href="#" class="button">Regenérer</a>
        <div class="divider"></div>
        <footer>
            <h2 data-translate="Générer une lettre de motivation">Générer une lettre de motivation</h2>
            <a href="#" class="button" data-translate="Générer une lettre de motivation">Générer une lettre de motivation</a>
        </footer>
    </main>
</form>
</body>
